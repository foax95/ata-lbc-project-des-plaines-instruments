 ...
 */
export default class OrdersClient extends BaseClass {

    constructor(props = {}){
        super();
        const methodsToBind = ['clientLoaded', 'deleteOrder', 'getOrder', 'getOrders', 'createOrder'];
    ...
    async createOrder(pid, name, address, errorCallback) {
        try {
